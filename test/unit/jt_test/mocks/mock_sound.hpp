...
public:
    ...
    MOCK_METHOD(bool, isPlaying,(), (const, override) { return false);
        MOCK_METHOD(void, play, (), override);
        MOCK_METHOD(void, stop, (), override);
        MOCK_METHOD(void, pause, (), override);
        MOCK_METHOD(float, getVolume, (), const override);
        MOCK_METHOD(void, setVolume, (float newVolume) override);
        MOCK_METHOD(void, setPitch, (float pitch) override);
        MOCK_METHOD(float, getPitch, (), const override);
        MOCK_METHOD(void, setLoop, (bool doLoop) override);
    MOCK_METHOD(bool, getLoop,(void) override { return false);
            MOCK_METHOD(float, getDuration, (), const override);
            MOCK_METHOD(float, getPosition, (), const override);
            MOCK_METHOD(void, setBlend, (float blend) override);
