    ...
    m_particlesFire = jt::ParticleSystem<jt::Shape, numberOfParticles>::createPS(
        [this]() {
            auto s = jt::dh::createShapeCircle(
                20, jt::ColorFactory::fromHSV(45, 80, 100), textureManager());
        ...
        [this](auto& s, auto /*pos*/) {
            ...
            auto intermediateColor = jt::ColorFactory::fromHSV(0, 60, 67);
            auto finalColor = jt::ColorFactory::fromHSV(318, 42, 27);
