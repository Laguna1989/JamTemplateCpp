#ifndef GUARD_JAMTEMPLATE_STATE_MANAGER_TRANSITION_HORIZONTAL_BARS_HPP
#define GUARD_JAMTEMPLATE_STATE_MANAGER_TRANSITION_HORIZONTAL_BARS_HPP
...
#endif // GUARD_JAMTEMPLATE_STATE_MANAGER_TRANSITION_HORIZONTAL_BARS_HPP
